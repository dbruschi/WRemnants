...
narf.clingutils.Declare('#include "muon_efficiencies_smooth_onlytrigiso.hpp"')
...
def make_muon_efficiency_helpers_smooth_onlytrigiso(
    ...
    if len(eff_types_3D):
        ...
        helper = ROOT.wrem_onlytrigiso.muon_efficiency_smooth3D_helper[
        ...
        helper_syst = ROOT.wrem_onlytrigiso.muon_efficiency_smooth3D_helper_syst[
            templateAnalysisArg, Nsyst, type(sf_syst_2D_pyroot), type(sf_syst_3D_pyroot)
        ](helper)
        ...
        sf_syst_2D_pyroot = narf.hist_to_pyroot_boost(sf_syst_2D)
        # nomi and syst are stored in the same histogram, just use different helpers to override the () operator for now, until RDF is improved
        helper = ROOT.wrem_onlytrigiso.muon_efficiency_smooth_helper[
            templateAnalysisArg, Nsyst, type(sf_syst_2D_pyroot)
        ](ROOT.std.move(sf_syst_2D_pyroot))
        helper_syst = ROOT.wrem_onlytrigiso.muon_efficiency_smooth_helper_syst[
            templateAnalysisArg, Nsyst, type(sf_syst_2D_pyroot)
        ](helper)
        # define axis for syst variations with all steps
        axis_all = hist.axis.Integer(
    ...
    for effStatKey in effStat_manager.keys():
        ...
        if smooth3D:
            if "sf_iso" in effStatKey:
                helper_stat = (
                    ROOT.wrem_onlytrigiso.muon_efficiency_smooth_helper_stat_iso_utDep[
                        templateAnalysisArg,
                        netabins,
                        nPtEigenBins,
                        ncharges,
                ...
                helper_stat = (
                    ROOT.wrem_onlytrigiso.muon_efficiency_smooth_helper_stat_utDep[
                        templateAnalysisArg,
                        netabins,
                        nPtEigenBins,
                        ncharges,
            ...
            if "sf_iso" in effStatKey:
                helper_stat = (
                    ROOT.wrem_onlytrigiso.muon_efficiency_smooth_helper_stat_iso[
                        templateAnalysisArg,
                        netabins,
                        nPtEigenBins,
                        ncharges,
                ...
                helper_stat = ROOT.wrem_onlytrigiso.muon_efficiency_smooth_helper_stat[
                    templateAnalysisArg,
                    netabins,
                    nPtEigenBins,
                    ncharges,
...
def make_muon_efficiency_helpers_smooth_altSyst_onlytrigiso(
    ...
    # case with only 2D histograms
    sf_syst_2D_pyroot = narf.hist_to_pyroot_boost(sf_syst_2D)
    helper_syst = ROOT.wrem_onlytrigiso.muon_efficiency_smooth_helper_syst_oneStep[
        templateAnalysisArg, Nsyst, type(sf_syst_2D_pyroot)
    ](ROOT.std.move(sf_syst_2D_pyroot))
    # define axis for syst variations with all steps

#ifndef WREMNANTS_MUON_EFFICIENCIES_SMOOTH_ONLYTRIGISO_H
#define WREMNANTS_MUON_EFFICIENCIES_SMOOTH_ONLYTRIGISO_H
...
template <wrem::AnalysisType analysisType, int NSysts, typename HIST_SF>
...
template <int NSysts, typename HIST_SF>
class muon_efficiency_smooth_helper<wrem::AnalysisType::Wlike, NSysts, HIST_SF>
    : public muon_efficiency_smooth_helper_base<NSysts, HIST_SF> {
...
template <int NSysts, typename HIST_SF>
class muon_efficiency_smooth_helper<wrem::AnalysisType::Dilepton, NSysts,
                                    HIST_SF>
    : public muon_efficiency_smooth_helper_base<NSysts, HIST_SF> {
...
// specialization for two-lepton case Wlike
template <int NSysts, typename HIST_SF>
class muon_efficiency_smooth_helper_syst<wrem::AnalysisType::Wlike, NSysts,
                                         HIST_SF>
    : public muon_efficiency_smooth_helper_base<NSysts, HIST_SF> {
...
// specialization for two-lepton case Dilepton
template <int NSysts, typename HIST_SF>
class muon_efficiency_smooth_helper_syst<wrem::AnalysisType::Dilepton, NSysts,
                                         HIST_SF>
    : public muon_efficiency_smooth_helper_base<NSysts, HIST_SF> {
...
// specialization for two-lepton case Wlike
template <int NSysts, typename HIST_SF, typename HIST_SF3D>
class muon_efficiency_smooth3D_helper<wrem::AnalysisType::Wlike, NSysts,
                                      HIST_SF, HIST_SF3D>
    : public muon_efficiency_smooth3D_helper_base<NSysts, HIST_SF, HIST_SF3D> {
...
// specialization for two-lepton case Dilepton
template <int NSysts, typename HIST_SF, typename HIST_SF3D>
class muon_efficiency_smooth3D_helper<wrem::AnalysisType::Dilepton, NSysts,
                                      HIST_SF, HIST_SF3D>
    : public muon_efficiency_smooth3D_helper_base<NSysts, HIST_SF, HIST_SF3D> {
...
// specialization for two-lepton case Wlike
template <int NSysts, typename HIST_SF, typename HIST_SF3D>
class muon_efficiency_smooth3D_helper_syst<wrem::AnalysisType::Wlike, NSysts,
                                           HIST_SF, HIST_SF3D>
    : public muon_efficiency_smooth3D_helper_base<NSysts, HIST_SF, HIST_SF3D> {
...
// specialization for two-lepton case Dilepton
template <int NSysts, typename HIST_SF, typename HIST_SF3D>
class muon_efficiency_smooth3D_helper_syst<wrem::AnalysisType::Dilepton, NSysts,
                                           HIST_SF, HIST_SF3D>
    : public muon_efficiency_smooth3D_helper_base<NSysts, HIST_SF, HIST_SF3D> {
...
// base template for one lepton case
template <wrem::AnalysisType analysisType, int NEtaBins, int NPtEigenBins,
...
// specialization for two-lepton case Wlike
template <int NEtaBins, int NPtEigenBins, int NCharges, typename HIST_SF>
class muon_efficiency_smooth_helper_stat<wrem::AnalysisType::Wlike, NEtaBins,
...
// specialization for two-lepton case Dilepton
template <int NEtaBins, int NPtEigenBins, int NCharges, typename HIST_SF>
class muon_efficiency_smooth_helper_stat<wrem::AnalysisType::Dilepton, NEtaBins,
                                         NPtEigenBins, NCharges, HIST_SF>
    : public muon_efficiency_smooth_helper_stat_base<NEtaBins, NPtEigenBins,
                                                     NCharges, HIST_SF> {
...
template <int NEtaBins, int NPtEigenBins, int NCharges, typename HIST_SF>
class muon_efficiency_smooth_helper_stat_iso<
    wrem::AnalysisType::Wlike, NEtaBins, NPtEigenBins, NCharges, HIST_SF>
    : public muon_efficiency_smooth_helper_stat_base<NEtaBins, NPtEigenBins,
                                                     NCharges, HIST_SF> {
...
template <int NEtaBins, int NPtEigenBins, int NCharges, typename HIST_SF>
class muon_efficiency_smooth_helper_stat_iso<
    wrem::AnalysisType::Dilepton, NEtaBins, NPtEigenBins, NCharges, HIST_SF>
    : public muon_efficiency_smooth_helper_stat_base<NEtaBins, NPtEigenBins,
                                                     NCharges, HIST_SF> {
...
// specialization for two-lepton case Wlike
template <int NSysts, typename HIST_SF>
class muon_efficiency_smooth_helper_oneStep<wrem::AnalysisType::Wlike, NSysts,
                                            HIST_SF>
    : public muon_efficiency_smooth_helper_base_oneStep<NSysts, HIST_SF> {
...
// specialization for two-lepton case Dilepton
template <int NSysts, typename HIST_SF>
class muon_efficiency_smooth_helper_oneStep<wrem::AnalysisType::Dilepton,
                                            NSysts, HIST_SF>
    : public muon_efficiency_smooth_helper_base_oneStep<NSysts, HIST_SF> {
...
// specialization for two-lepton case Wlike
template <int NSysts, typename HIST_SF>
class muon_efficiency_smooth_helper_syst_oneStep<wrem::AnalysisType::Wlike,
                                                 NSysts, HIST_SF>
    : public muon_efficiency_smooth_helper_base_oneStep<NSysts, HIST_SF> {
...
// specialization for two-lepton case Dilepton
template <int NSysts, typename HIST_SF>
class muon_efficiency_smooth_helper_syst_oneStep<wrem::AnalysisType::Dilepton,
                                                 NSysts, HIST_SF>
    : public muon_efficiency_smooth_helper_base_oneStep<NSysts, HIST_SF> {
